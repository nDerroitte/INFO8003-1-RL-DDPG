...
class GUI:
    def __init__(self, width=640, height=640, bar_width=50, bar_height=10, fruit_size=20, dt=30, make_video=False,
                 display=True):
        """
        Parameters:
        -----------
    ...
    def __draw(self, env, nb_episode):
        ...
        fruit_position = (env.fruit.center[0] - self.fruit_size[0]/2, env.fruit.center[1] - self.fruit_size[1]/2)
